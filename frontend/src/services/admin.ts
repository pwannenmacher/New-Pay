...
export const adminApi = {
  // User management
  getUser: (userId: number) => apiClient.get<UserWithRoles>(`/admin/users/get?id=${userId}`),
  ...
  listUsers: (params: UserListParams = {}) => {
    ...
    return apiClient.get<PaginatedResponse<UserWithRoles>>(
      `/admin/users/list?${queryParams.toString()}`
    );
  },
  ...
  // Role management
  listRoles: () => apiClient.get<Role[]>('/admin/roles/list'),
  ...
  listAuditLogs: (params: AuditLogListParams = {}) => {
    ...
    return apiClient.get<PaginatedResponse<AuditLog>>(
      `/admin/audit-logs/list?${queryParams.toString()}`
    );
  },
  ...
  listCatalogs: () => apiClient.get<CriteriaCatalog[]>('/admin/catalogs'),
  ...
  updateCatalogValidUntil: (catalogId: number, validUntil: string) =>
    apiClient.put<CriteriaCatalog>(`/admin/catalogs/${catalogId}/valid-until`, {
  ...
  updatePath: (catalogId: number, categoryId: number, pathId: number, data: Partial<Path>) =>
    apiClient.put<Path>(
      `/admin/catalogs/${catalogId}/categories/${categoryId}/paths/${pathId}`,
      data
    ),
